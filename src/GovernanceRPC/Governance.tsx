                                ...
                                <>
                                    ...
                                    {item?.pubkey && item?.account &&
                                        <TableRow key={index} sx={{borderBottom:"none"}}>
                                            ...
                                            <TableCell align="center">
                                                <GetParticipants governanceAddress={governanceAddress} item={item} realm={realm} tokenMap={tokenMap} memberMap={memberMap} governanceToken={governanceToken} />
                                            </TableCell>
                                        </TableRow>
                                    }
                                </>
                    ...
                    > 
                        ...
                        {endTime &&
                            <Typography 
                                ...
                                sx={{textAlign:'center'}}
                            >
                                Rendering Time: {Math.floor(((endTime-startTime) / 1000) % 60)}s ({Math.floor((endTime-startTime))}ms) RPC<br/>*This timer is only for the time it has taken to capture the general proposals & does not include proposal details
                            </Typography>
                        }
                    </Box>
