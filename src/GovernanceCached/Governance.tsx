                    ...
                    > 
                        ...
                        {endTime &&
                            <Typography 
                                ...
                                sx={{textAlign:'center'}}
                            >
                                Rendering Time: {Math.floor(((endTime-startTime) / 1000) % 60)}s ({Math.floor((endTime-startTime))}ms) Cached<br/>* This is the time taken to capture all proposals & proposal details
                            </Typography>
                        }
                    </Box>
