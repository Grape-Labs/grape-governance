...
export const RPC_ENDPOINT = QUICKNODE_RPC_ENDPOINT || ALCHEMY_RPC_ENDPOINT || QUICKNODE_RPC_ENDPOINT || ALCHEMY_RPC_ENDPOINT || SHYFT_RPC_ENDPOINT || HELLO_MOON_ENDPOINT || HELIUS_RPC_ENDPOINT || 'https://api.mainnet-beta.solana.com';
export const RPC_DEVNET_ENDPOINT = ALCHEMY_RPC_DEVNET_ENDPOINT || QUICKNODE_RPC_DEVNET_ENDPOINT || ALCHEMY_RPC_DEVNET_ENDPOINT || QUICKNODE_RPC_DEVNET_ENDPOINT || SHYFT_RPC_DEVNET_ENDPOINT || HELLO_MOON_DEVNET_ENDPOINT || HELIUS_RPC_DEVNET_ENDPOINT || 'https://api.devnet.solana.com';
