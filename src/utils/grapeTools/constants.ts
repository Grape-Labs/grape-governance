...
export const RPC_ENDPOINT = QUICKNODE_RPC_ENDPOINT || SHYFT_RPC_ENDPOINT || QUICKNODE_RPC_ENDPOINT || ALCHEMY_RPC_ENDPOINT || SHYFT_RPC_ENDPOINT || HELLO_MOON_ENDPOINT || HELIUS_RPC_ENDPOINT || 'https://api.mainnet-beta.solana.com';
